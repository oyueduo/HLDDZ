...
bool GameScene::init()
{
	...
	//提示
	auto hintSprite1 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_191.png");//不
	auto hintSprite2 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_192.png");//出
	auto hintSprite3 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_191.png");//1
	hintSprite3->setScale(0.9f);
	auto hintSprite4 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_192.png");//牌1
...
void GameScene::callLandlord()      //叫地主
{
	if (_currentPlayer == _player1)
	{
		...
		bujiaoButton->setVisible(false);
		if (rand() % 10 > 5)                //玩家2
			this->runAction(Sequence::create(DelayTime::create(2.0f), CallFunc::create(CC_CALLBACK_0(GameScene::landlords, this)), NULL));       //抢地主
		else
			this->runAction(Sequence::create(DelayTime::create(2.0f), CallFunc::create(CC_CALLBACK_0(GameScene::notQiangLandlord, this)), NULL));   //不抢
...
void GameScene::landlords()        //抢地主
{
	if (_currentPlayer == _player1)
	{
		if (wantLandlord.front() == _player1)
		{
			...
			this->getChildByTag(CLOCKSPRITE)->runAction(FadeOut::create(0.1f));         //更新时钟位置
			this->getChildByTag(CLOCKSPRITE)->setPosition(Vec2(PLAYER1X2, PLAYER1Y2));
			((Clock*)this->getChildByTag(CLOCKSPRITE))->setTime(30);
			this->getChildByTag(CLOCKSPRITE)->runAction(FadeIn::create(0.1f));
...
void GameScene::notWantLandlord()   //不叫
{
	if (_currentPlayer == _player1)
	{
		...
		if (rand() % 10 > 5)                //玩家2
			...
			this->runAction(Sequence::create(DelayTime::create(2.0f), CallFunc::create(CC_CALLBACK_0(GameScene::notWantLandlord, this)), NULL));   //不叫
	...
	else if (_currentPlayer == _player2)
	{
		...
		if (rand() % 10 > 5)                //玩家2
			...
			this->runAction(Sequence::create(DelayTime::create(2.0f), CallFunc::create(CC_CALLBACK_0(GameScene::notQiangLandlord, this)), NULL));   //不叫
	}
	else
	{
...
void GameScene::notQiangLandlord()  //不抢
{
	if (_currentPlayer == _player1)
	{
...
//	qiangButton->setContentSize(Size(qiangButton->getContentSize().width * 2, qiangButton->getContentSize().height));
//
//	auto qiangSprite = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_167.png");//抢
//	auto buSprite = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_177.png");//不
//	auto qiangSprite1 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_167.png");//抢1
//	qiangSprite1->setScale(0.9f);
//	auto buSprite1 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_170.png");//不1
//	buSprite1->setScale(0.9f);
//	auto normalBuBgL = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_285.png");//出牌左背景
//	auto normalBuBgR = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_285.png");//出牌右背景
//	auto selectedBuBgL = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_286.png");//出牌左背景
...
//			/*log("_currentCard.size 2= %d", _currentPlayer->getCurrentCard().size());*/
//			/*std::sort(_currentPlayer->getCurrentCard().begin(), _currentPlayer->getCurrentCard().end(), GameRule::largerCard);*/
//			_cardType = _gameRule->getCardType();                    //更新当前牌型，大小，长度
//			_cardArrayNumber = _gameRule->getCardArrayNumber();
//			_cardLength = _gameRule->getCardLength();
//
//
...
//		}
//		//出的牌不合理
//		else if (_currentPlayer == _player1)  //牌不合理
//		{
//			auto sp1 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_282.png");
//			auto sp2 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_287.png");
//			auto sp3 = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_283.png");
...
//			}), NULL));
//
//			_player2BuJiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除其他人的不叫
...
//			addLandlordCard();                //添加地主牌
//
//			jiaoButton->setEnabled(false);      //禁用抢地主按钮
//			bujiaoButton->setEnabled(false);
//
//			jiaoButton->setVisible(false);
//			bujiaoButton->setVisible(false);
...
//		changePlayer(_player2);
//		this->getChildByTag(CLOCKSPRITE)->runAction(FadeOut::create(0.1f));           //更新时钟
//		this->getChildByTag(CLOCKSPRITE)->setPosition(Vec2(PLAYER2X, PLAYER2Y));
//		((Clock*)this->getChildByTag(CLOCKSPRITE))->setTime(15);
//		this->getChildByTag(CLOCKSPRITE)->runAction(FadeIn::create(0.1f));
//
...
//		{
//			_player1BuJiao->removeFromParentAndCleanup(true);       //清除不叫
//		}
//		if (_player1Jiao != NULL)                                   //清除叫地主
//		{
//			_player1Jiao->removeFromParentAndCleanup(true);
//		}
//		_player1Qiang = Sprite::createWithSpriteFrameName("HLDDZ_MainGame0_2x_42_03.png");//抢
...
//			{
//				_player2Qiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除抢
//					_player2Qiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player2BuQiang != NULL)
//			{
//				_player2BuQiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除不抢
//					_player2BuQiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player3Qiang != NULL)
//			{
//				_player3Qiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除抢
//					_player3Qiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player3BuQiang != NULL)
//			{
//				_player3BuQiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除不抢
...
//		{
//			_player2BuJiao->removeFromParentAndCleanup(true);   //清除不叫
//		}
//		if (_player2Jiao != NULL)                                   //清除叫地主
//		{
...
//			{
//				_player1Qiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除抢
//					_player1Qiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player1BuQiang != NULL)
//			{
//				_player1BuQiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除不抢
...
//			return;
//		}
//		if (_player2->getIsWantLandlord() == false)//player3没叫，player1叫了，
//		{
//			changePlayer(_player1);
//			this->getChildByTag(CLOCKSPRITE)->runAction(FadeOut::create(0.1f));
//			this->getChildByTag(CLOCKSPRITE)->setPosition(Vec2(PLAYER1X, PLAYER1Y));
...
//		{
//			_player3BuJiao->removeFromParentAndCleanup(true);  //清除不叫
//		}
//		if (_player3Jiao != NULL)                                   //清除叫地主
//		{
...
//		buqiangButton->setVisible(false);
//		notWantLandlordTimes++;
//		if (_player2->getIsWantLandlord() == false)//第一个player2人没叫地主，第二个人叫了
//		{
...
//			if (_player2BuJiao != NULL)
//			{
//				_player2BuJiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除2不叫
//					_player2BuJiao->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player3Jiao != NULL)
//			{
//				_player3Jiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除3叫
//					_player3Jiao->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			selectLandlord(_player3);          //选择player3为地主
...
//			{
//				_player2Jiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除2叫
//					_player2Jiao->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player2BuQiang != NULL)
//			{
//				_player2BuQiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除2不抢
//					_player2BuQiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player2Qiang != NULL)
//			{
//				_player2Qiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除2抢
//					_player2Qiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player3BuQiang != NULL)
//			{
//				_player3BuQiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除3不抢
//					_player3BuQiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player3Qiang != NULL)
//			{
//				_player3Qiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除3抢
//					_player3Qiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			selectLandlord(wantLandlord.back());          //选择最后一个抢地主的为地主
...
//			if (_player3BuJiao != NULL)
//			{
//				_player3BuJiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除3不叫
//					_player3BuJiao->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player1Jiao != NULL)
//			{
//				_player1Jiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除1叫
//					_player1Jiao->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
...
//			if (_player1BuQiang != NULL)
//			{
//				_player1BuQiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除1不抢
//					_player1BuQiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player1Qiang != NULL)
//			{
//				_player1Qiang->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除1抢
//					_player1Qiang->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player3BuQiang != NULL)
...
//			if (_player1BuJiao != NULL)
//			{
//				_player1BuJiao->runAction(Sequence::create(DelayTime::create(0.3f), CallFunc::create([&]() {     //清除1不叫
//					_player1BuJiao->removeFromParentAndCleanup(true);
//				}), NULL));
//			}
//			if (_player2Jiao != NULL)
